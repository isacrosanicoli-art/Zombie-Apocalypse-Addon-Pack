...
NÃO ative recursos Beta/Preview do próprio Minecraft que estejam em desenvolvimento, a menos que sejam especificamente necessários para algum addon.
...
Por isso, STUTTER e quedas de FPS podem acontecer até mesmo em PCs e celulares potentes.

Isso não significa necessariamente que o dispositivo seja fraco. O próprio pack pode gerar uma carga bastante alta.

CONFIGURAÇÃO UTILIZADA COMO REFERÊNCIA:

Dispositivo: POCO X7 Pro
Gráficos: Bonito
Distância de renderização: 16 chunks
Nuvens: Desativadas
Frame Pacing: Desativado
...
Os zumbis evoluem conforme os dias passam e podem se tornar extremamente perigosos. A progressão continua até o dia 100, aumentando gradualmente a ameaça.

SOLO + HARDCORE é a experiência recomendada.
...
Only enable experimental features related to Add-On functionality/creation, such as Creator Features / Beta APIs when required.

DO NOT enable Minecraft Beta/Preview features that are still under development unless they are specifically required by an addon.
...
Dynamic lighting
Sunlight/ray effects passing through trees
Other advanced lighting effects

These effects can cause visual bugs with the weapons, making them disappear from the player's hand. This is only a visual bug, but it can seriously affect gameplay.
...
Because of this, STUTTERING and FPS drops may occur even on powerful PCs and phones.

This does not necessarily mean your device is weak. The pack itself can create a very high workload.
...
Zombies evolve as the days pass and can become extremely dangerous. Their progression continues up to Day 100, gradually increasing the threat.

SOLO + HARDCORE is the recommended way to play.
